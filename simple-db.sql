...
INSERT INTO public.stuff (id, salary, job_title, first_name, last_name, age, experience, phone_number, email, password, description) VALUES (11, 1000.00, 'Director', 'Ivan', 'Kuzbasov', 40, 10, '89012375983', 'Kuzbasov@tabacoo.shop', NULL, 'Директор');
INSERT INTO public.stuff (id, salary, job_title, first_name, last_name, age, experience, phone_number, email, password, description) VALUES (12, 1000.00, 'Director', 'Stanislav', 'Kopal', 34, 4, '89012375443', 'Kopal@tabacoo.shop', NULL, 'Директор');
INSERT INTO public.stuff (id, salary, job_title, first_name, last_name, age, experience, phone_number, email, password, description) VALUES (13, 1000.00, 'Director', 'Olga', 'Ivanova', 35, 5, '89251239292', 'Ivanova@tabacoo.shop', NULL, 'Директор');
INSERT INTO public.stuff (id, salary, job_title, first_name, last_name, age, experience, phone_number, email, password, description) VALUES (14, 1000.00, 'Director', 'Egor', 'Valuev', 42, 12, '89234251234', 'Valuev@tabacoo.shop', NULL, 'Директор');
INSERT INTO public.stuff (id, salary, job_title, first_name, last_name, age, experience, phone_number, email, password, description) VALUES (15, 1000.00, 'Direcot', 'Dmitriy', 'Chubaev', 23, 5, '89102342554', 'Chubaev@tabacoo.shop', NULL, 'Директор');
